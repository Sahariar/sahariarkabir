				...
				<div className="details flex flex-col-reverse lg:flex-row pb-10">
					<div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-10 mx-auto">
						...
						<div className="card w-80 md:w-96 mx-auto bg-base-100 shadow-xl hover:shadow-2xl">
							<figure>
								<img
									src="https://i.ibb.co/YWsGDtr/2023-01-12-222155.jpg"
									alt="Book Society"
									className="rounded-t-xl object-cover"
								/>
							</figure>
							<div className="card-body">
								<h2 className="card-title">Book Society (Team Project)</h2>
								<p>
									Books Society is place where user can read books and test
									their skill and communicate with like minded.
								</p>
								...
								<div className="flex justify-between">
									<a
										href="https://books-society.vercel.app/"
										target="_blank"
										className="btn btn-primary mt-0 gap-2 w-5/12"
									>
										<HiOutlineLink className="text-2xl" />
										Live Link
									</a>
									<a
										href="https://github.com/Sahariar/books-society"
										target="_blank"
										className="btn btn-primary mt-0 gap-2 w-5/12"
									>
										<BiDetail className="text-2xl" /> Details
									</a>
								</div>
							</div>
						</div>
						...
						<div className="card w-80 md:w-96 mx-auto bg-base-100 shadow-xl hover:shadow-2xl">
							...
							<div className="card-body">
								...
								<div className="flex justify-between">
									<a
										href="https://resell-game-console-market.web.app/"
										target="_blank"
										className="btn btn-primary mt-0 gap-2 w-5/12"
									>
										<HiOutlineLink className="text-2xl" />
									...
									<Link
										to={"/projects/resell-game-console"}
										className="btn btn-primary mt-0 gap-2 w-5/12"
									>
										<BiDetail className="text-2xl" /> Details
									</Link>
						...
						<div className="card w-80 md:w-96 mx-auto bg-base-100 shadow-xl hover:shadow-2xl">
							...
							<div className="card-body">
								...
								<div className="flex justify-between">
									<a
										href="https://getlookinggreat.web.app/"
										target="_blank"
										className="btn btn-primary mt-0 gap-4"
									>
										{" "}
										<HiOutlineLink className="text-2xl" />
										Live Link
						...
						<div className="card w-80 md:w-96 mx-auto bg-base-100 shadow-xl hover:shadow-2xl">
							...
							<div className="card-body">
								<h2 className="card-title">Cyber Education</h2>
								<p>A Place where Teach About ABC Of Cyber Security</p>
								<div className="card-actions justify-center py-5">
									<p>Used Technologies</p>
									<p className="flex gap-2 flex-wrap">
										<span>HTML 5,</span>
								...
								<div className="flex justify-between">
									<a
										href="https://cyber-education-b16df.web.app/"
										target="_blank"
										className="btn btn-primary mt-0 gap-4"
									>
										{" "}
						...
						<div className="card w-80 md:w-96 mx-auto bg-base-100 shadow-xl hover:shadow-2xl">
							...
							<div className="card-body">
								...
								<p>
									A Place To Test Your Theory ofProgramming Languages.A quiz is
									a form of game or mind sport in which players attempt to
									answer questions correctly about a certain or variety of
									subjects.{" "}
								</p>
								<div className="card-actions justify-center py-5">
									<p>Used Technologies</p>
								...
								<div className="flex justify-between">
									<a
										href="https://interview-quash.netlify.app/"
										target="_blank"
										className="btn btn-primary mt-0 gap-4"
									>
										{" "}
						...
						<div className="card w-80 md:w-96 mx-auto bg-base-100 shadow-xl hover:shadow-2xl">
							...
							<div className="card-body">
								...
								<p>A Cooking Recipe Book For your Favorite Food.</p>
								<div className="card-actions justify-center py-5">
									<p>Used Technologies</p>
									<p className="flex gap-2 flex-wrap">
										<span>HTML 5,</span>
								...
								<div className="flex justify-between">
									<a
										href="https://recipe-hut-meal.netlify.app/"
										target="_blank"
										className="btn btn-primary mt-0 gap-4"
									>
										{" "}
