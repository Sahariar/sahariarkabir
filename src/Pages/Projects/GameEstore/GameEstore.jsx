...
<div className="container flex flex-col justify-center p-4 mx-auto">
    ...
    <img className="object-contain w-full aspect-square" src="https://i.ibb.co/51x587g/game-e.png" />
    <img className="object-contain w-full aspect-square" src="https://i.ibb.co/8zLn5Lc/catelouge.png" />
    <img className="object-contain w-full aspect-square" src="https://i.ibb.co/TLJ1q7n/orderpage.png" />
