...
const CyberEdu = () => {
	...
	<div className="container flex flex-col justify-center p-4 mx-auto">
        ...
        <img className="object-contain w-full aspect-square" src="https://i.ibb.co/whNVn1g/cyber-Education.png" />
		<img className="object-contain w-full aspect-square" src="https://i.ibb.co/6W6f0D5/singlepage.png" />
        <img className="object-contain w-full aspect-square" src="https://i.ibb.co/5hQWcS5/curriculum.png" />
