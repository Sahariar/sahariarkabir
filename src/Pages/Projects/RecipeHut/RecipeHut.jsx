...
<div className="container flex flex-col justify-center p-4 mx-auto">
    ...
    <img className="object-contain w-full aspect-square" src="https://i.ibb.co/0tTfFvY/hutarea.png" />
    <img className="object-contain w-full aspect-square" src="https://i.ibb.co/p3P31rz/singlepage.png" />
    <img className="object-contain w-full aspect-square" src="https://i.ibb.co/7CHW4t5/recipehut.png" />
